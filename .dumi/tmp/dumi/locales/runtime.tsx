...
import { RawIntlProvider, createIntl, createIntlCache } from '/Users/chenshuhang/Documents/alito/uitls/node_modules/.pnpm/react-intl@6.7.0/node_modules/react-intl';
import { useIsomorphicLayoutEffect } from '/Users/chenshuhang/Documents/alito/uitls/node_modules/.pnpm/dumi@2.4.12_prettier@2.8.8/node_modules/dumi/dist/client/theme-api/utils.js'
...
const LocalesContainer: FC<{ children: ReactNode }> = (props) => {
  const getIntl = useCallback(() => {
    ...
    localeMessages['$internal.edit.link'] = "https://github.com/alitojs/utils/edit/main/{filename}";

    localeMessages['$internal.api.sourceLink'] = "https://github.com/alitojs/utils/tree/main/{fileName}#L{line}";
